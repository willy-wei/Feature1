...
namespace Feature1
{
    ...
    public partial class RadForm1 : Telerik.WinControls.UI.RadForm
    {
        ...
        private void machOne_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                ControlPaint.DrawBorder(e.Graphics, this.machOne.ClientRectangle, Color.Green, ButtonBorderStyle.Solid);
            }
            else if (machOne.CncStrStatus == "停止中")
            {
                ControlPaint.DrawBorder(e.Graphics, this.machOne.ClientRectangle, Color.Black, ButtonBorderStyle.Solid);
            }
            else if (machOne.CncStrStatus == "閒置中")
            {
                ControlPaint.DrawBorder(e.Graphics, this.machOne.ClientRectangle, Color.White, ButtonBorderStyle.Solid);
            }
        }
        private void machTwo_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                ControlPaint.DrawBorder(e.Graphics, this.machTwo.ClientRectangle, Color.Green, ButtonBorderStyle.Solid);
            }
            else if (machTwo.CncStrStatus == "準備中")
            {
                ControlPaint.DrawBorder(e.Graphics, this.machTwo.ClientRectangle, Color.Yellow, ButtonBorderStyle.Solid);
            }
            else if (machTwo.CncStrStatus == "閒置中")
            {
                ControlPaint.DrawBorder(e.Graphics, this.machTwo.ClientRectangle, Color.White, ButtonBorderStyle.Solid);
            }
        }
